...
func (nu *NoteUpdate) SetExternalReference(dr *domain.ExternalReference) *NoteUpdate {
	nu.mutation.SetExternalReference(dr)
	return nu
}

// ClearExternalReference clears the value of the "external_reference" field.
func (nu *NoteUpdate) ClearExternalReference() *NoteUpdate {
	nu.mutation.ClearExternalReference()
	return nu
}
...
func (nu *NoteUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := nu.mutation.ExternalReference(); ok {
	...
	if nu.mutation.ExternalReferenceCleared() {
...
// SetExternalReference sets the "external_reference" field.
func (nuo *NoteUpdateOne) SetExternalReference(dr *domain.ExternalReference) *NoteUpdateOne {
	nuo.mutation.SetExternalReference(dr)
	return nuo
}

// ClearExternalReference clears the value of the "external_reference" field.
func (nuo *NoteUpdateOne) ClearExternalReference() *NoteUpdateOne {
	nuo.mutation.ClearExternalReference()
	return nuo
}
...
func (nuo *NoteUpdateOne) sqlSave(ctx context.Context) (_node *Note, err error) {
	...
	if value, ok := nuo.mutation.ExternalReference(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: note.FieldExternalReference,
	...
	if nuo.mutation.ExternalReferenceCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: note.FieldExternalReference,
		})
